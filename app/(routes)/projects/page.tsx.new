...
const projects = [
  {
    ...
    description: "Built a live-updating Angular dashboard using RxJS and WebSockets to stream financial data.",
  ...
  },
  {
    ...
    description: "Refactored and optimized PrimeNG-based UI components, enhancing performance and user experience.",
  ...
  },
  {
    ...
    description: "Integrated basic user auth with AWS Cognito for secure login flows in a test environment.",
  ...
  },
  {
    ...
    description: "A personal site built with Next.js to showcase my skills and projects.",
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {projects.map((project, index) => (
            ...
            >
              ...
              <h2 className="text-2xl font-semibold pr-24">{project.title}</h2>
